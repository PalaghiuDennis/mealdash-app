    ...
    <aside>
      ...
      <!--Main-->
        ...
        while($row=$result->fetch_assoc()){
          ...
          <td>" . $row["telefon"] . "</td>
          <td>" . $row["adresa"] . "</td>
          <td>" . $row["data_trimiteri"] . "</td>
          <td>" . $row["statusc"] . "</td>";
          echo '<td><form action="pagina_detalii_comanda.php" method="POST">';
          echo '<input type="hidden" name="comandaID" value="' . $comandaID . '">';
