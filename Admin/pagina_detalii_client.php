...
$sql = "SELECT * FROM clienti WHERE clientID = '$clientID'";
...
<h2>Modificare date client</h2>
  <form action="procesare_modificare_client.php" method="POST">
...
<label for="status">Adresa:</label> <input type="text" name="adresa" id="adresa" value="<?php echo $adresa; ?>"><br>
