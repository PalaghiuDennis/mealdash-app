...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="http://localhost/Proiect/User/user.php" class="logo d-flex align-items-center me-auto me-lg-0">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Setari</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
      ...
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          ...
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="http://localhost/Proiect/User/cosul_meu.php" class="btn-book-a-table">Cosul Meu</a>
         ...
         <?php while ($row = $result->fetch_assoc()): ?>
          <li>
                ...
                <div class="product-info">
                    ...
                    <button class="buy-btn" onclick="saveToTextFile(<?php echo $row["id"]; ?>); location.reload();">Cumpără</button>
                </div>
            </li>
        <?php endwhile; ?>
        </ul>
